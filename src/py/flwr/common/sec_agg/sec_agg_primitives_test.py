...
def test_signature():
    pub_key, priv_key = rsa.newkeys(1024, poolsize=multiprocessing.cpu_count())
    print(pub_key)
    msg = pickle.dumps([pub_key,priv_key])
    signature= rsa.sign(msg, priv_key, hash_method="SHA-1")
    print(signature)
